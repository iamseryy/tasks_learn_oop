### Реализовать класс для работы с одномерными динамическими массивами произвольных данных(произвольного типа). Использовать Kotlin. Класс будет иметь следующие конструкторы:
